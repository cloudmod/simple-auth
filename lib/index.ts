...
export interface SimpleAuthProps {
   ...
   */
  passwordPolicy?: SimpleAuthPasswordPolicy;
}

export interface SimpleAuthPasswordPolicy {
  /**
...
export class SimpleAuth extends Construct {
  ...
  constructor (scope: Construct, id: string, props?: SimpleAuthProps) {
    super(scope, id);
    ...
    new CfnOutput(scope, 'SimpleAuthUserPoolId', { value: this.userPool.ref });
    new CfnOutput(scope, 'SimpleAuthUserPoolClientId', { value: this.defaultClient.ref });
    new CfnOutput(scope, 'SimpleAuthIdentityPoolId', { value: this.identityPool.ref });
  }
}
